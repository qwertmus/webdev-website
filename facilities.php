...
<head>
  ...
  <title>Facilities at Cantor College</title>
</head>
<body>
  <header>
  <?php
  ...
  <div class="InfoSectionColumn"> 
    <div class="InfoSection">
      <img src="images\12226216184_b8d6e0073a_b.jpg" alt=""  >   
      
    </div>
  </div>
  <div class="InfoSectionColumn"> 
    <div class="InfoSection">
    <h1 class="title">Facilities in the college</h1>
    ...
    <div class="InfoSection">
      <h3 class="headliner">Facilities include:</h1>
      <ul>
  ...
  <div class="InfoSectionColumn"> 
    <div class="InfoSection">       
      <img src="images\IMG_0170.jpeg" alt="" >
    </div>
  </div>
  </main>
